...
\newcommand{\pageone}{
  \begin{titlepage}
    ...
    \vskip 0.4 in
    \centerline{\LARGE{Version 8.1, July 2019}}
    \vskip 0.1 in
    \centerline{(\textit{Minor update of Version 8.0, December 2018})}
    \vskip 1.5 in
    ...
    \centerline{at http://math.hws.edu/javanotes8/.  The web site includes}
    ...
    \noindent\copyright 1996--2019, David J. Eck
    ...
    \noindent The web site for this book is:\ \ \ http://math.hws.edu/javanotes8
...
\newcommand{\pageonelinked}{
  \begin{titlepage}
   ...
   \centerline{\url{http://math.hws.edu/javanotes8/}.  The PDF does not include}
...
\newcommand{\pageoneluluall}{
  \begin{titlepage}
    ...
    \centerline{available at http://math.hws.edu/javanotes8/.  The web site}
