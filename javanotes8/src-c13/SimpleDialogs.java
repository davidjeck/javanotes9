...
public class SimpleDialogs {
	...
	public static Color showColorDialog( Color initialColor) {
		return showColorDialog(initialColor, "Select a Color");
	}

	public static Color showColorDialog( Color initialColor, String title) {
