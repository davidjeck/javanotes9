...
public class Life extends JPanel implements ActionListener, MouseListener, MouseMotionListener {
	...
	private MosaicCanvas display;  // Displays the game to the user..  White squares are alive; black squares are dead.
	...
	public Life() {
		...
		display = new MosaicCanvas(GRID_SIZE,GRID_SIZE,cellSize,cellSize);
		if (cellSize < 5)
