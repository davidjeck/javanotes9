 ...
 * on.  See https://math.hws.edu/xJava/PentominosSolver for a greatly enhanced version of this program,
...
public class LittlePentominos extends JPanel {
	...
	public LittlePentominos() {
		...
		board = new MosaicCanvas(rows,cols,50,50,Color.GRAY,2);  // for displaying the board
