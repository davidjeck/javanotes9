...
public class MultiprocessingDemo1 extends JPanel {
	...
	private volatile int threadsRunning; // how many threads are still runnin?
	...
	private void start() {
		...
		threadsRunning = threadCount;  // Records how many of the threads still need to terminate.
